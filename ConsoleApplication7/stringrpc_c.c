...
/* Standard interface: stringrpc, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO stringrpc_ProxyInfo;


static const RPC_CLIENT_INTERFACE stringrpc___RpcClientInterface =
    {
...
RPC_IF_HANDLE stringrpc_v1_0_c_ifspec = (RPC_IF_HANDLE)& stringrpc___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const MIDL_STUB_DESC stringrpc_StubDesc = 
    {
    (void *)& stringrpc___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &stringrpc__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& stringrpc_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO stringrpc_ProxyInfo =
    {
    &stringrpc_StubDesc,
    stringrpc__MIDL_ProcFormatString.Format,
    stringrpc_FormatStringOffsetTable,
